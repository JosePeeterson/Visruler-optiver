...
def randomSearchAB(XData, X_train, y_train, X_test, clf, params, eachAlgor, AlgorithmsIDsEnd, crossValidation, randomS, RANDOM_SEED, roundValue):
    ...
    print('Reached end of AdaBoost')
    return # resultsXGB


XData = pd.read_csv('C:\Finance_projects\VisRuler-paper-version\VisRuler-paper-version\data\optiver_500.csv')
...
resultsLocalAB = randomSearchAB(XData, X_train, y_train, X_test, clf, paramsAB, 'AB', AlgorithmsIDsEnd, crossValidation, randomSearchVar, RANDOM_SEED, roundValueSend)  
