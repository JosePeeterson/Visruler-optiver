(function (global, factory) {
  ...
  */
    ...
    var getSumOfArray = function (numArray) {
      var i = 0; var n = numArray.length; var sum = 0
    ...
    function linkCrossings () {
      var i; var j; var c = 0; var d = 0; var link1; var link2; var line1; var line2
    ...
    // intersect.
      ...
      // the lines share only one point and the angle must be 180.
        ...
        !(onSegment(line2[0], line2[1], line1[0]) && onSegment(line2[0], line2[1], line1[1]))) { return 180 } else return 0
      }
